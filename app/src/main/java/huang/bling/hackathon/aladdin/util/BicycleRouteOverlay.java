...
/**
 * Created by 沈东 on 2017/11/6.
 */

public class BicycleRouteOverlay {
    ...
    public BicycleRouteOverlay(Context context) {
        mContext = context;
    }
    ...
    protected BitmapDescriptor getEndBitmapDescriptor() {
        return BitmapDescriptorFactory.fromResource(R.drawable.ic_place_green_36dp);
    }
...
//                .position(startPoint).icon(getStartBitmapDescriptor()));
    ...
    protected int getDriveColor() {
        return Color.parseColor("#33C11E");
    }
}
