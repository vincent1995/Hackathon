...
package huang.bling.hackathon.aladdin.widget.wheelpick;
...
//    	canvas.drawLine(0, getItemDimension()+(getMeasuredHeight()/2-getItemDimension())/2,getMeasuredWidth(),getItemDimension()+(getMeasuredHeight()/2-getItemDimension())/2, linePaint);
//    	canvas.drawLine(0, getMeasuredHeight()/2+(getMeasuredHeight()/2-getItemDimension())/2,getMeasuredWidth(),getMeasuredHeight()/2+(getMeasuredHeight()/2-getItemDimension())/2, linePaint);
        canvas.save();
